...
export const skills = [
  ...
  {
    category: "Security",
    items: ["Penetration Testing", "Network Security", "Linux Administration"],
  },
  {
    category: "Languages",
...
export const experience = [
  ...
  },
  {
    ...
    focus: "Modern web platform with real-time features",
    current: false,
  },
  {
    company: "Kampus Gratis",
    ...
    period: "Feb – Apr 2025",
    stack: ["AWS EC2", "CI/CD Pipeline", "Kafka"],
...
export const education = [
  {
    ...
    program: "S1 Informatika — Informatics Engineering",
    period: "2022 – 2026",
  },
  {
